  ...
  public Robot() {
    ...
    switch (Constants.currentMode) {
      case REAL:
        ...
        aprilTagVision1 =
            new AprilTagVision(
                new AprilTagVisionIOLimelight(limelight1Name, limelight1Position), poseManager);
        aprilTagVision2 =
            new AprilTagVision(
                new AprilTagVisionIOLimelight(limelight2Name, limelight2Position), poseManager);
        break;
