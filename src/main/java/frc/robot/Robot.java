...
public class Robot extends LoggedRobot {
  ...
  private void configureButtonBindings() {
    ...
    operator
        .a()
        .onTrue(elevator.request(L1).alongWith(Commands.runOnce(() -> scoreState = ScoreL1)));
    operator
        .b()
        .onTrue(
            Commands.runOnce(
    ...
    new Trigger(() -> poseManager.distanceToStationFace() < 0.5)
        ...
        .whileTrue(carriage.intakeCoral().beforeStarting(() -> Leds.getInstance().intakingActivated = true)
