...
public final class FieldConstants {
  ...
  private static final LoggedTunableNumber extraXOffset = new LoggedTunableNumber("Distances/extraX", .75 / 2 + .2);
  public static final LoggedTunableNumber extraYOffset = new LoggedTunableNumber("Distances/extraY", 0);
  ...
  private static final DoubleSupplier xOffset = () -> Units.inchesToMeters(30.738) + extraXOffset.get();
  private static final DoubleSupplier yOffset = () -> Units.inchesToMeters(6.469) + extraYOffset.get();

  public static enum Branch {
    A(
        () -> new Pose2d(reefCenter, Rotation2d.fromDegrees(180 + (60 * 0)))
            .transformBy(new Transform2d(xOffset.getAsDouble(), -yOffset.getAsDouble(), new Rotation2d(Math.PI)))),
    B(
        () -> new Pose2d(reefCenter, Rotation2d.fromDegrees(180 + (60 * 0)))
            .transformBy(new Transform2d(xOffset.getAsDouble(), yOffset.getAsDouble(), new Rotation2d(Math.PI)))),
    C(
  ...
  public static enum Face {
    One(
        () -> new Pose2d(reefCenter, Rotation2d.fromDegrees(180))
            .transformBy(new Transform2d(xOffset.getAsDouble(), 0, new Rotation2d(Math.PI))),
        Branch.A,
        Branch.B,
        true),
    Two(
